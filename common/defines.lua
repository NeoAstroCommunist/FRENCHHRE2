...
NDiplomacy = {
	...
	DISHONORABLE_PEACE_MONTHS = 36,  -- See DISHONORABLE_PEACE_WARSCORE. Set to 0 to entirely disable the feature.
	DISHONORABLE_PEACE_WARSCORE = -20,  -- If you have more than this amount of individual warscore peacing out within DISHONORABLE_PEACE_MONTHS of war start counts as a dishonorable act and incurs a CALL_ALLY_DECLINE_PRESTIGE_PENALTY hit.
	...
	FAVOR_GAIN_FOR_HELP = 30,  -- Amount of favors gained for helping allies in wars (based on war contribution relative to their power)
	...
	OVEREXTENSION_THRESHOLD = 50.0,  -- at which threshold you can get events
	...
	MAX_PEACE_TREATY_COST = 500,  -- in diplo power
	...
	HRE_PRINCE_AUTHORITY_THRESHOLD = 40,  -- Threshold below which you lose IA and above which you gain it
	IMPERIAL_AUTHORITY_FROM_PRINCES = 0.12,  -- Scales to threshold
	...
	HRE_HERETIC_PENALTY = -0.005,  -- Per heretic prince (halved by Peace of Westphalia)
	...
	CELESTIAL_EMPIRE_REFORM_MIN_VALUE = 999,  -- Minimum value of Mandate above which new reforms can be enacted.
	...
	WE_IMPACT_ON_ANNEX_INTEGRATE = -0.075,  -- multiplied with current WE
	...
	MONARCH_GOV_CHANGE_LEGITIMACY_PENALTY = 0.25,  -- Penalty(%) on the legitimacy when changing gov type to the monarchy
	...
	HRE_VOTE_HERETIC = -25,  
	HRE_VOTE_OVERLORD = 100,  
	HRE_VOTE_VASSAL_ELECTOR = -10,  
	HRE_VOTE_TOO_SMALL = -100,  
	HRE_VOTE_BIG_COUNTRY = 50,  
	HRE_VOTE_VERY_BIG_COUNTRY = 100,  
	HRE_VOTE_NON_MEMBER = -125,  
	HRE_VOTE_SAME_CULTURE_GROUP = 75,  
	HRE_VOTE_ALLIANCE = 25,  
	HRE_VOTE_ROYAL_MARRIAGE = 5,  
	HRE_VOTE_CORE_CLAIM = -25,  
	...
	SPY_NETWORK_TECH_EFFECT = -0.025,  
	SPY_NETWORK_TECH_EFFECT_MAX = -0.2,  
	DETECTED_SPY_NETWORK_DAMAGE_MIN = 20,  
	DETECTED_SPY_NETWORK_DAMAGE_MAX = 70,  
	SPY_NETWORK_DISCOVER_WAR = 50,
	SUPPORT_REBELS_EFFECT = 10,
	SUPPORT_REBELS_MONEY_FACTOR = 0.5,
	FABRICATE_CLAIM_COST = 40,  
	...
	AE_OTHER_CONTINENT = 100,  
	AE_SAME_CULTURE = 0.5,  
	AE_SAME_CULTURE_GROUP = 0.25,  
	AE_INFIDEL_CONQUEST = 0.25,  -- different religion group conquered same religion province
	AE_SAME_RELIGION = 0.20,  
	AE_SAME_RELIGION_GROUP = 0.1,  
	AE_DIFFERENT_RELIGION = -0.5,  
	AE_HRE_INTERNAL = 0.75,  
	AE_ATTACKER_DEVELOPMENT = 0.005,  -- +50% cap (at 1000 development)
	AE_DEFENDER_DEVELOPMENT = 0.005,  -- -50% cap (at 1000 development)
	AE_DISTANCE_BASE = 0.85,  -- previously 0.73
	AE_SAME_OVERLORD = 0.5,  
	AE_PROVINCE_CAP = 20,  -- Province development above this will not count for AE (also used for warscore cost cap)
	AE_THREATEN_WAR = 0.8,  
	AE_PRIMITIVES = -0.75, -- less AE from primitives

	-- Peace Option Effects, base values for the winner. The loser gets the inverse.
	PO_DEMAND_PROVINCES_AE = 1.00,  -- _DDEF_PO_DEMAND_PROVINCES_AE = 10 (Per development)
	PO_RETURN_CORES_AE = 0.5,  -- (Per core only applied if returning cores to vassals of winner)
	PO_FORM_PU_AE = 0.3,  -- _DDEF_PO_FORM_PU_AE = 10 (Per development)
	PO_CONCEDE_COLONIAL_AE = 0.3,  
	...
	PEACE_COST_DEMAND_PROVINCE = 1.25,  -- Demand a province (scales by province wealth also used for annex)
	PEACE_COST_CONCEDE_PROVINCE = 1,  -- Demand colonial area province concession.
	PEACE_COST_BECOME_VASSAL = 0.9,  -- Vassalize a country (scales by province wealth)
	...
	PEACE_COST_RELEASE_VASSAL = 1,  -- Release vassal (scales by province wealth)
	...
	PEACE_COST_CONVERSION = 0.3,  -- scaled with countrysize for forced conversion in peace.
	...
	WARGOAL_PEACE_FRACTION = 0.9,  -- Fraction of warscore you need for wargoal
	CLAIM_PEACE_COST_DIP_FRACTION = -0.25,  -- Fraction of dipcost you pay for claims
	CORE_PEACE_COST_DIP_FRACTION = -0.5,  -- Fraction of dipcost you pay for cores
	...
	CELESTIAL_EMPIRE_MANDATE_PER_STABILITY = 0.6,  -- Yearly change of Mandate for each point of positive stability
	CELESTIAL_EMPIRE_MANDATE_PER_STATE_WITH_PROSPERITY = 0.02,  -- Yearly change of Mandate for each State with prosperity.
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_DEVASTATION = -0.60,  -- Yearly change of Mandate for each hundred devastated development (scaled to devastation).
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_TRIBUTARY_DEV = 0.10,  -- Yearly change of Mandate for each hundred development tributary state.
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_NONTRIBUTARY_DEV = 0,  -- Yearly change of Mandate for each hundred development of neighbouring states that are not the Emperor's tributaries
	...
	IMPERIAL_CITY_IA = 0.007,						-- Monthly per imperial free city
	...
	BREAK_ALLIANCE_STRENGTH_OFFSET = 1.5,  -- If relative alliance strength is above this threshold, start applying gradient.
	BREAK_ALLIANCE_STRENGTH_GRADIENT = 15,  -- Relative alliance strength to acceptance value, capped at +100.
	BREAK_ALLIANCE_DISTANCE_FACTOR = -0.275,  -- AI acceptance factor depending on distance.
	...
	TRIBUTE_BASE_CASH = 0.15,  -- Tributary State: Part of yearly income given in tribute
	...
	TRIBUTE_MAX_MONARCH_POWER = 4.0,  -- Tributary State: Max Adm/Dip/Mil per Tributary
	...
	REFUSED_CALL_FROM_TRIBUTARY_MANDATE_LOSS = 5,  -- Mandate lost when Celestial Emperor refuses CtA from a tributary subject
	...
	CHARTER_COMPANY_BASE_COST = 999999,  
	CHARTER_COMPANY_MINIMUM_COST = 999999,  
...
NCountry = {
	CLEAR_PROVINCE_VARIABLES_ON_CLEAR_OWNER = 0,  
	CLEAR_PROVINCE_FLAGS_ON_CLEAR_OWNER = 0,  
	CLEAR_PROVINCE_SAVED_NAMES_ON_CLEAR_OWNER = 0,  
	...
	SIBERIAN_FRONTIER_DAILY_BASE = 2,  -- monthly..
	SIBERIAN_FRONTIER_DAILY_RANGE = 7,  
	...
	NEW_HEIR_PRESTIGE_THRESHOLD = 999,  -- Disable "Introduce heir" button
	NEW_HEIR_LEGITIMACY_HIT = -20,
	NEW_HEIR_LEGITIMACY_THRESHOLD = 999,  -- Disable "Introduce heir" button
	...
	STATE_MAINTENANCE_DISTANCE_FACTOR = 0,  -- distance
	STATE_MAINTENANCE_CONTINENT_FACTOR = 0,  -- different continet
	STATE_MAINTENANCE_CULTURE_FACTOR = 0,  -- non accepted culture
	...
	ESTATE_DROP_LOYALTY_IF_LOST_PRIVILEDGE = 0,  
	ESTATE_ANGRY_THRESHOLD = -999,  
	ESTATE_HAPPY_THRESHOLD = 999,  
	ESTATE_LOYALTY_DECAY_BASE_MIN = 0,  -- Loyalty change per year at middle level.
	ESTATE_LOYALTY_DECAY_BASE_MAX = 0,  -- Loyalty change per year at most extreme levels.
	...
	ESTATE_MIN_DISTRIBUTED_CROWNLAND = 0.0,  
	ESTATE_CROWNLAND_INFLUENCE = 0.0,  
	ESTATE_START_CROWNLAND_INFLUENCE = 0.0,  
	ESTATE_CROWNLAND_FROM_DEV = 0.0,  

	ESTATE_PRIVILEGE_ADMIN_COST = 0,			-- Cost of granting a privilege
	ESTATE_PRIVILEGES_MAX_CONCURRENT = 999,  -- Max. number of privileges active at the same time
	...
	HRE_RANK = 6,  -- Emperor of the HRE is displayed as this rank (for ruler title only)
	HRE_MAX_RANK = 6,  -- for members
	HRE_MAX_RANK_ELECTOR = 6,  -- for electors
	...
	MIN_DEVELOPMENT_FOR_GOV_RANK_2 = 99999,  -- Need at least this much development to upgrade to government rank 2
	MIN_DEVELOPMENT_FOR_GOV_RANK_3 = 99999,  -- Need at least this much development to upgrade to government rank 3
	...
	ADDITIONAL_MIN_DEVELOPMENT_FOR_GOV_RANK_X = 99999,  -- ADDITIONAL development needed to upgrade to government rank above 3
	MAX_GOV_RANK = 6,  -- Max possible is 10
	...
	CIRCUMNAVIGATION_PROVINCE_4 = 1992,  -- Provinces for circumnavigation (sulu sea)
	CIRCUMNAVIGATION_PROVINCE_5 = 2027,  -- Provinces for circumnavigation (horn of africa)
	CIRCUMNAVIGATION_PROVINCE_6 = 2038,  -- Provinces for circumnavigation (cape of good hope)

	MIN_DEV_FOR_OLD_GREAT_POWER = 400,  -- Countries with less development than this cannot be considered Great Powers

	SUPPORT_OWN_HEIR_PRESTIGE_COST = 10,
	SUPPORT_OWN_HEIR_SUPPORT_BONUS = 5,
	ELECTIVE_HEIR_CLAIM_STRENGTH = 80,
	MAX_ACTIVE_POLICIES = 7,  -- how many active policies at once.
	...
	GREAT_PROJECT_DEGRADATION_PERCENT_PER_MONTH = 0.00, --how much a great project degrades in % per month
	...
	MAXIMUM_ADVISOR_SKILL = 2,  -- Maximum advisor skill reachable through promotion
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 1.5,  -- Promote advisor cost in monthly salaries
	CULTURE_LOSS_THRESHOLD = 0.00,  -- _CDEF_CULTURE_LOSS_THRESHOLD = 10
	CULTURE_GAIN_THRESHOLD = 0.50,  -- _CDEF_CULTURE_GAIN_THRESHOLD = 10
	...
	CULTURE_MIN_DEVELOPMENT_TO_PROMOTE = 15,  -- Minimum development required to promote the culture.
	MONARCH_DEATH_STABILITY_PENALTY = 0,  -- Stab hit on monarch death
	...
	POWER_MAX = 2424,  -- how much power can be stored at maximum.
	DISMANTLE_HRE_PRESTIGE = 100,					-- Prestige gain on dismantling HRE
	CROWN_LANDS_ALERT_THRESHOLD = 30,
	FREE_IDEA_GROUP_COST = 1,  -- modifier on cheapness of "free" idea group
	...
	IDEA_TO_TECH = -0.0075,  -- percentage on tech reduction per idea.
	TECH_TIME_COST = 0.2,  -- tech grow with 20% cost over time.
	...
	PS_MAKE_PROVINCE_CORE = 8,  
	PS_REDUCE_INFLATION = 75,
	PS_PROMOTE_MERCANTILISM = 9999,  
	PS_MOVE_CAPITAL = 400,  
	...
	PS_SEIZE_COLONY = 25,
	PS_BURN_COLONY = 10000,  
	PS_ATTACK_NATIVES = 5,
	PS_SCORCH_EARTH = 5,
	PS_CHANGE_GOVERNMENT = 9999,  
	...
	PS_IMPROVE_PROVINCE_BASE = 0,  ---DO SMASHED THE BUTTON
	PS_IMPROVE_PROVINCE_MUL = 0,  
	PS_IMPROVE_PROVINCE_CAPITAL_DISCOUNT = 0,  
	...
	CORE_COLONY = 0.1,  -- Multiplied with development colonized by country or overseas
	CORE_OVERSEAS = 0.5,  -- Multiplied with development colonized by country or overseas
	CORE_SAME_REGION = 0.80,  -- Multiplied with development for colonial nations
	CORE_SAME_CONTINENT = 0.80,  -- Multiplied with development for colonial nations
	CORE_HAD_CLAIM = 0.25,  -- Impacts MODIFIER_CORE_CREATION
	CORE_HAD_PERMANENT_CLAIM = 0.50,  -- Impacts MODIFIER_CORE_CREATION

	FACTION_BOOST_SIZE = 10,  
	WAREXHAUSTION_REDUCTION = 1,  
	HARSH_TREATMENT_IN_MONTHS = 180,  
	RECENT_UPRISING_IN_MONTHS = 180,  
	UNREST_REVOLT_FACTOR = 0.6,  -- How much does each point of unrest contribute to chance of revolt uprising increasing (base)
	...
	BREAK_MARRIAGE_PRESTIGE_PENALTY = -20,  
	BREAK_MARRIAGE_STABILITY_PENALTY = 0,  
	FORM_MARRIAGE_HIGHER_PRESTIGE = -1,  
	FORM_MARRIAGE_HIGHER_LEGITIMACY = -2,  
	...
	CLAIM_LOSE = 50,  -- how many years until a claim is lost.
	...
	NEIGHBOURBONUS_CAP = -0.2,  -- _CDEF_NEIGHBOURBONUS_CAP_
	NEIGHBOURBONUS_CORRUPTION = 0.0,
	LAGGINGTECH_CORRUPTION = 0,  -- Corruption increase/year. Multiplied by (highest - lowest) tech level
	LAGGINGTECH_CORRUPTION_MAX = 0.0,  -- Max increase/year
	POPULATION_GROWTH = 0.03,  -- _CDEF_POPULATION_GROWTH_; Base population growth.
	COLONIAL_GROWTH_PENALTY = 25,  -- growth penalty for low colonial maintenance
	BANKRUPTCY_COLONIAL_GROWTH_PENALTY = -200, 		-- growth penalty for bankruptcy
	MAX_NATIONALISM = 10, 
	MIN_NATIONALISM = -30, 
	YEARS_OF_NATIONALISM = 75,  -- _CDEF_YEARS_OF_NATIONALISM_; Years of Nationalism
	...
	MONTHS_TO_CORE_MAXIMUM = 60,  -- Maximum amount of months it will take to core a province after all modifiers.
	...
	MONTHS_TO_CHANGE_CULTURE = 120,  -- How many months it will take to change culture in a province per development.
	RELEASED_NATION_ARMY_SIZE = 0.5,				-- Newly released nations get an army of this size
	STARTING_ARMY_SIZE = 0,  -- Percentage of force limit
	STARTING_ARMY_SIZE_AT_WAR = 0,  -- Percentage of force limit
	STARTING_ARMY_SIZE_REBEL_THREAT = 0,  -- Percentage of rebel threat added to percentage of force limit
	STARTING_FLEET_SIZE = 0,  -- Starting fleet (as percentage of forcelimits)
	...
	REVOLT_SIZE_DEVELOPMENT_MULTIPLIER = 0.225,  -- Multiplied with the province's development
	REVOLT_SIZE_BASE = 1,  
	REVOLT_TECH_IMPACT = 0.005,  -- % each tech increases size of rebels by this percent.
	REVOLT_TECH_MORALE = 0.005,  -- 1% per tech level

	REBEL_ARTILLERY_INCREASE_LEVEL_1_TECH = 29,  -- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_1_SIZE is applied
	REBEL_ARTILLERY_INCREASE_LEVEL_1_SIZE = 0.1,  -- The increase in artillery as fraction of total troops given to rebels
	REBEL_ARTILLERY_INCREASE_LEVEL_2_TECH = 46,  -- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE is applied
	...
	TARIFF_LIBERTY_INCREASE = 0.0,  -- Liberty increase for each % tariffs
	...
	LIBERTY_DESIRE_MERCANTILISM = 0.0,  -- Liberty desire from overlord's mercantilism (per Merc).
	...
	LIBERTY_DESIRE_HISTORICAL_FRIEND = -10,  -- Liberty desire from being historical friends
	LIBERTY_DESIRE_HISTORICAL_RIVAL = 10,  -- Liberty desire from being historical rivals
	LIBERTY_DESIRE_TRUST = -0.2,  -- Liberty desire from trust
	LIBERTY_DESIRE_POSITIVE_OPINION = -0.1,  -- Liberty desire from positive opinion
	LIBERTY_DESIRE_NEGATIVE_OPINION = 0.3,  -- Liberty desire from negative opinion
	...
	LIBERTY_DESIRE_DEVELOPED_IN_SUBJECT = 0, --Needs to be zero to prevent players from abusing selecting provinces in subjects
	...
	RELATIVE_ON_THRONE_LIBERTY = 75,  
	RELATIVE_ON_THRONE_NOT_REGENCY_LIBERTY = 50,  
	ENFORCE_RELIGION_LIBERTY_THRESHOLD = 50,  
	ENFORCE_CULTURE_LIBERTY = 99,  
	ENFORCE_CULTURE_LIBERTY_THRESHOLD = -1,  
	ENFORCE_CULTURE_TAX_MULTIPLIER = 2,  
	SIPHON_INCOME_FRACTION = 0.5,
	SIPHON_INCOME_LIBERTY = 10,
	DIVERT_TRADE_FRACTION = 0.5,  
	...
	SEIZE_TERRITORY_LIBERTY_MULTIPLIER = 3,  
	...
	PROMOTE_INVESTMENTS_TRADEPOWER = 0.15,  
	PROMOTE_INVESTMENTS_INFLATION = 0.05,  
	...
	PILLAGE_CAPITAL_DEVELOPMENT_DECREASE = 0.0,  -- Pillage cannot be disabled so at least dont move dev
	RAZE_UNREST_DURATION = 10,  -- Years of unrest. Also used for duration of neg. opinion modifier for previous owner.
	RAZE_PROVINCE_DEVELOPMENT_DECREASE = 0.01,  
	RAZE_PROVINCE_POWER_PER_DEVELOPMENT = 0.0,  
	...
	RAZE_PROVINCE_COOLDOWN_YRS = 999,  
	RAZE_PROVINCE_CONQUERED_TIME_LIMIT_MONTHS = 6,  
	HORDE_UNITY_PER_LOOT = 0,  -- Horde unity gained per ducat looted.
	HORDE_UNITY_PER_RAZE = 0,  -- Horde unity gained per development level razed.
	DEVOTION_PER_RAZE = 0.33,						-- Devotion gained per development level razed.
	PILLAGE_CAPITAL_MAX_DEV_PILLAGED = 0,  -- This doesnt seem to work
	...
	TRADE_FAVORS_FOR_GOLD_FAVOR_COST = 33,  
	TRADE_FAVORS_FOR_GOLD_REQUIRED_OPINION = 100,  
	TRADE_FAVORS_FOR_MEN_FAVOR_COST = 999,  
	TRADE_FAVORS_FOR_MEN_REQUIRED_OPINION = 999,  
	TRADE_FAVORS_FOR_SAILORS_FAVOR_COST = 999,  
	TRADE_FAVORS_FOR_SAILORS_REQUIRED_OPINION = 999,  
	TRADE_FAVORS_FOR_HEIR_FAVOR_COST = 90,  
	TRADE_FAVORS_FOR_HEIR_REQUIRED_OPINION = 150,  
	TRADE_FAVORS_FOR_TRUST_REQUIRED_OPINION = 75,  
	TRADE_FAVORS_FOR_WAR_PREP_REQUIRED_OPINION = 75,  
	...
	CONSORT_TAKEOVER_LEGITIMACY_HIT = -10,  
	...
	SETTLEMENT_GROWTH_DEVELOPMENT_INCREASE = 0,  -- How much development may increase per year if a colonist is working on Settlement Growth.
	SETTLMENT_GROWTH_CHANCE_MULTIPLIER = 0,  -- Affects chance of development increase per year if a colonist is working on Settlement Growth.
	SETTLMENT_GROWTH_CHANCE_MIN = 0,  -- Minimum chance of increasing development for colonists promoting Settlement Growth
	SETTLEMENT_GROWTH_CHECK_INTERVAL = 200000,  -- Interval in days between checks for random development increase when working in Settlement Growth.
...
NEconomy = {
	...
	DEBASE_MAX_STORED_MONTHS = 0,  -- Debase currency stores up to this many months of charges.
	DEBASE_MONTHS_PER_CHARGE = 30,  -- Amount of months used for one debase charge.
	DEBASE_MAX_CORRUPTION = 90,  -- Above this level of corruption, you won't be able to Debase Currency.
	DEBASE_ADDED_CORRUPTION = 10,  -- This amount of corruption added per standard sized bank loan worth of currency.
	GOLD_MINE_SIZE = 30,  -- Base income from gold mines {was 40 vanilla}
	GOLD_MINE_DEPLETION_THRESHOLD = 999,  -- Gold mines above production level or above can be depleted
	GOLD_MINE_DEPLETION_CHANCE = 0,  -- Chance of gold mine being depleted (yearly, per production above threshold)
	GOLD_MINE_SIZE_PRIMITIVES = 20,  
	TRADE_POWER_HOME_BONUS = 0.05,  
	TRADE_POWER_HOME_BONUS_MAX = 0.10,  
	AUTONOMY_AT_DIPLO_ANNEX = 20,  -- Autonomy added when diplo-annexing
	AUTONOMY_AT_CONQUEST = 20,  -- Autonomy added at conquest
	AUTONOMY_AT_CONQUEST_CLAIM = 10,  -- Autonomy added at conquest if you have a claim
	AUTONOMY_AT_CONQUEST_CORE = 0,  -- Autonomy added at conquest if you have a core
	COLONY_MIN_AUTONOMY = 0,  -- Capital province autonomy can never be above this
	CAPITAL_MAX_AUTONOMY = 100,  -- Capital province autonomy can never be above this
	DECREASE_AUTONOMY_STEP = -5,  
	DECREASE_AUTONOMY_MIN = 1,  
	INCREASE_AUTONOMY_STEP = 5,  
	INCREASE_AUTONOMY_MAX = 99,  
	AUTONOMY_CHANGE_DURATION = 10950,  -- about 10 years
	LAND_TECH_MAINTENANCE_IMPACT = 0,  -- % each tech increases it.   #CHANGED FROM 0.05 BY DO OVERHAUL
	NAVAL_TECH_MAINTENANCE_IMPACT = 0.02, 			-- % each tech increases it.
	LAND_TECH_MERC_MAINTENANCE_IMPACT = 0.08, 			-- % each tech increases it.
	ADVISOR_COST = 0.10,  -- Advisor cost modifier (was 1.0 by Khardinal)
	...
	BANKRUPTCY_PROVINCE_DEVASTATION_GAIN = 0,  
	...
	LAND_MAINTENANCE_FACTOR = 0.10,  -- _EDEF_LAND_MAINTENANCE_FACTOR  ### Demian changed from 1.5, but base costs were increased
	HEAVY_SHIP_MAINT_FACTOR = 0.10,  -- _EDEF_HEAVY_SHIP_MAINT_FACTOR_
	LIGHT_SHIP_MAINT_FACTOR = 0.10,  -- _EDEF_LIGHT_SHIP_MAINT_FACTOR_
	GALLEY_MAINT_FACTOR = 0.10,  -- _EDEF_GALLEY_MAINT_FACTOR_
	TRANSPORT_MAINT_FACTOR = 0.10,  -- _EDEF_TRANSPORT_MAINT_FACTOR_
	COLONIAL_MAINTENANCE_FACTOR = 2.0,  -- _EDEF_COLONIAL_MAINTENANCE_FACTOR_ # In vanilla is 8 which means 2 ducats/month at full slider
	MISSIONARY_MAINTENANCE_FACTOR = 0.0,  
	MISSIONARY_MAINTENANCE_DEVELOPMENT_FACTOR = 0.5,  
	MISSIONARY_MAINTENANCE_AUTONOMY_FACTOR = 0.0,  -- does nothing currently.
	MISSIONARY_MAINTENANCE_AUTONOMY_BASE = 0.1,  
	MISSIONARY_MAINTENANCE_DEVELOPMENT_CAP = 45,  
	...
	MISSIONARY_TIME_BASE = 5000,  
	MISSIONARY_TIME_DISTANCE = 0.5,  
	...
	TRADED_FRACTION_FOR_BONUS = 2.00,  -- 200% required trade control of a trade good makes it impossible to obtain the "Trading in <trade good>" bonus.
	OPEN_SEA_MODIFIER = 1.7,						-- _EDEF_OPEN_SEA_MODIFIER_
	COASTAL_MODIFIER = 0.7,  -- _EDEF_COASTAL_MODIFIER_
	TRADE_CAPITAL_POWER = 0.5,  
	MERCHANT_SPEED = 20.0,							-- MERCHANT_SPEED
	MERCHANT_MAX_POWER_BONUS = 0.5,  -- was 0.5
	TRADE_SHIP_MAX_DAYS_IN_PORT = 5.0,				-- TRADE_SHIP_MAX_DAYS_IN_PORT
	TRADE_SHIP_ORG_LIMIT = 0.5,						-- TRADE_SHIP_ORG_LIMIT
	TRADE_NON_CAPITAL_OFFICE = 0,  -- TRADE_NON_CAPITAL_OFFICE
	TRADE_MERCHANT_PRESENT = 0.15,  -- was 0.05
	EMBARGO_BASE_EFFICIENCY = 0.75,  -- EMBARGO_BASE_EFFICIENCY
	EMBARGO_MERCANTILISM_EFFICIENCY = 50,			-- Percentage added to embargo efficiency modifier scaled by mercantilism.
	TRADE_ADDED_VALUE_MODIFER = 0.0,  -- This is actually multiplied by 2.26, because paradox.
	TRADE_PROPAGATE_DIVIDER = 20,  -- was 5
	TRADE_PROPAGATE_THRESHOLD = 1,  -- was 2
	REGAIN_COST_BEFORE_PROGRESS = 0.1,				-- Before what percentage will the full cost be regained
	ALLOW_DESTROY_MANUFACTORY = 1,  -- Should the player be permitted to destroy manufactories?
	PIRATES_TRADE_POWER_FACTOR = 1.5,  
	PIRATES_MONOPOLY_BONUS = 2,  -- Factor of monopolization of node added to privateer power efficiency.
	TRADE_COMPANY_CONTROL_LIMIT = 0.6,
	TRADE_COMPANY_DAYS_TO_SWAP_LEADER = 30,
	TRADE_COMPANY_STRONG_LIMIT = 0.10,  -- Minimum share in trade node at which to give trade_company_strong static modifier to country
	TRADE_COMPANY_COOLDOWN = 60,
	TRADE_COMPANY_RELIGION_RESTRICTION = 0,			-- If we limit trade companies based on religion.
	LARGE_COLONIAL_NATION_LIMIT = 3,  -- Thought this was connected to large_colonial_nation static modifier to overlord, however merchants from CNs seem broken (inconsistent) so can't tell. Vanilla is 10
	PRIVATEER_INCOME_COLLECTION_EFF = 0.35,  
	MIN_ARMY_MAINTENANCE = 0.1,
	MIN_NAVY_MAINTENANCE = 0.1,
	CARAVAN_FACTOR = 50,  -- Development is divided by this factor, do not set to zero! {was 50}
	CARAVAN_POWER_MAX = 15,  
	CARAVAN_POWER_MIN = 0.0,  
	MAX_BUILDING_SLOTS = 49,  -- vanilla 12, Maximum number of buildings slots, i.e. max buildings possible.
...
NMilitary = {
	SLACKEN_AP_DROP = 1.5,  -- Requiring over a 100% AP (>1) so it can not be used
	SLACKEN_MANPOWER_INCREASE = 0,  -- Zeroing just in case. Used to be 2.
	...
	FORT_DEVASTATION_IMPACT = 0,  
	REVANCHISM_DEVASTATION_IMPACT = 0,  
	SURRENDER_DEVASTATION_IMPACT = 0,  
	CONTROL_DEVASTATION_IMPACT = 0,  
	PASSIVE_DEVASTATION_IMPACT = 0,  

	DEVASTATION_DEVELOPMENT_SCALE = 0,  
	...
	FORT_PER_DEV_RATIO = 30,  -- 1 non-obsolete maintained fort per this amount of development = +1 AT
	...
	SIEGE_MEMORY = 100,  -- Default: 11
	SIEGE_MEMORY_SCALED = 0,  -- Default: 1
	SIEGE_WIN = 20,
	...
	HEAVY_SHIP_SAILORS_COST = 600,  -- 1 = 1000 men in cost.
	LIGHT_SHIP_SAILORS_COST = 200,  -- 1 = 1000 men in cost.
	GALLEY_SHIP_SAILORS_COST = 100,  -- 1 = 1000 men in cost.
	TRANSPORT_SHIP_SAILORS_COST = 50,  -- 1 = 1000 men in cost.
	MAX_MANPOWER = 10,  -- years in mp pool
	MIN_MONTHLY_MANPOWER = 0.00,  -- 150 men/month is minimum    # DO MODIFIED FROM .15
	...
	INFANTRY_COST = 1.0,  -- _MDEF_INFANTRY_COST = 10	     was 14 Modified by Demian  was 28 modified by KJH
	CAVALRY_COST = 1.0,  -- _MDEF_CAVALRY_COST = 10	     was 22 Modified by Demian  was 44 modified by KJH
	ARTILLERY_COST = 1.0,  -- _MDEF_ARTILLERY_COST = 10	 was 32 Modified by Demian  was 64 modified by KJH
	FORTRESS_COST = 0.2,  -- monthly cost per fortlevel.
	HEAVY_SHIP_COST = 10,  -- _MDEF_HEAVY_SHIP_COST = 10   was 50 modified by KJH
	LIGHT_SHIP_COST = 10,  -- _MDEF_LIGHT_SHIP_COST = 10   was 30 modified by KJH
	GALLEY_COST = 10,  -- _MDEF_GALLEY_COST = 10   was 14 modified by KJH
	...
	LIGHT_SHIP_TIME = 545,  -- _MDEF_LIGHT_SHIP_TIME = 10
	GALLEY_TIME = 365,  -- _MDEF_GALLEY_TIME = 10
	TRANSPORT_TIME = 275,  -- _MDEF_TRANSPORT_TIME = 10
	MONTHLY_REINFORCE = 0.1,  --- reinforce moved back to 10 to account for higher attrition
	MONTHLY_REPAIR = 0.04,  -- Ship repair speed.
	EXTRA_LAND_REINFORCE_COST = 1.00,  -- extra cost for reinforcing land units (as a multiplier of maintenance). Was 1.5, changed by Demian / Was 3.0 changed by Khardinal 20/11/2016
	MERCENARY_REINFORCE_COST_MULTIPLIER = 0.00,  -- +80% extra cost for mercenaries being reinforced.
	MERCENARY_BASE_COST = 43.0,  -- base cost added for a mercenary regiment
	TRADITION_GAIN_LAND = 30,  -- Tradition gain base value from land combat.
	TRADITION_GAIN_NAVAL = 45,  -- Tradition gain base value from naval combat.
	CONDOTTIERI_TRADITION_BONUS = 1,  
	...
	BASE_COMBAT_WIDTH = 9.0,  -- _MDEF_BASE_COMBAT_WIDTH_
	MAX_COMBAT_WIDTH = 40,
	FORCE_MARCH_FACTOR = 0.5,						--
	LOOT_DEVASTATION_IMPACT = 0,  
	SCORCHED_DEVASTATION_IMPACT = 10,  
	SCORCHED_DURATION = 60,				-- months
	LOOTED_DAYS = 730,  -- Time the "Looted" static modifier lasts.
	LOOTED_SCALE = 0,  -- Scaling value from province development to number of ducats it contains.
	LOOTED_MAX = 50,  -- Maximum amount of ducats (total) a province can be looted for each month.
	LOOTED_RECOVERY = 0.05,  -- Speed at which a looted province recovers in fractional units per month (multiply by 100 for percentage).
	NAVAL_SUPPLY_RANGE = 120,  -- Supply range for ships.
	...
	SUPPLYLIMIT_BASE_MULTIPLIER = 1.0,  --
	WAR_LENGTH_DAMAGE_MODIFIER = 0.025,  -- How much (by percentage) the damage dealt will be increased each day of the combat {was 0.02}
	...
	SHATTERED_RETREAT_SPEED_MODIFIER = 0.25,  -- How much (by percentage) the movement speed will be modified when doing a shattered retreat
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.5,  -- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal {was 0.4 Vanilla}
	WARGOAL_MAX_BONUS = 30,  -- was 25
	DEFAULT_WARGOAL_WARSCORE_BONUS = 4,  -- Warscore bonus { was 5 }
	DEFAULT_WARGOAL_BATTLESCORE_BONUS = 8,  -- Battle score bonus from winning battles { was 8 }
	SUPERIORITY_WARGOAL_WARSCORE_THRESHOLD	= 10,	-- Needed battle score for getting ticking war score for war goal superiority
	WARSCORE_MAX_FROM_BATTLES = 50,  -- maximum amount to get from a battles . { was 40 }
	...
	OVERRUN_FACTOR = 25,  -- (Was 10 in vanilla.) How much stronger one side of a battle must be to cause the other side to be overrun (integer)
	OVERRUN_FACTOR_CANNOT_LEAVE = 5,  -- (Was 2 in vanilla.) Same as OVERRUN_FACTOR, but when combat cannot be left by the combattants. (integer)
	CANNOT_RETREAT_DAYS = 7,  -- (Was 12 in vanilla.) How many days combat has to last before one side can retreat
	DAYS_PER_PHASE = 3,								-- How many days each fire and shock phase lasts
	DAYS_PER_SIEGE_PHASE = 18,  --- was 30.  Siege length reduced by a third, deadliness increased.
	COMBAT_DICE_SIDE = 10,							-- How many sides the dice used in combat has
	BLOCKADE_FACTOR = 3,  -- (Total sail speed / blockade_factor) * blockade_efficiency / province base tax
	...
	REBEL_LEADER_POWER = 18,  -- The higher this value the more pips rebel leaders will have on average
	...
	PRESTIGE_FROM_LAND = 5,  -- Maximum base prestige from land battles (unmodified).
	PRESTIGE_FROM_NAVAL = 5,  -- Maximum base prestige from naval battles (unmodified).
	...
	INF_LOOT = 0,  -- How many ducats/month will a single full strength infantry regiment loot?
	...
	COSSACKS_USES_CONSTRUCTION = 0,  
	JANISSARIES_USES_CONSTRUCTION = 0,  
	CAWA_USES_CONSTRUCTION = 0,
	HUSSARS_USES_CONSTRUCTION = 1,
	CAROLEAN_USES_CONSTRUCTION = 1,
	RAJPUT_USES_CONSTRUCTION = 0,  
	MARINES_USES_CONSTRUCTION = 0,  
	REVOLUTIONARY_GUARD_USES_CONSTRUCTION = 0,  
	...
	MERCENARY_COMPANY_HIRING_COST_MONTHS = 30,  -- Initial hiring cost in months of maintenance
	MERCENARY_COMPANY_STARTING_MORALE = 0.5,  -- Starting morale
	MERCENARY_COMPANY_MIN_REGIMENTS = 1,  -- Minimum regiments
	MERCENARY_COMPANY_MAX_REGIMENTS = 15,  -- Maximum regiments
...
NAI = {
	...
	ACCEPTABLE_BALANCE_DEFAULT = 1.10,  -- vanilla 1.2 - Beorsferth: try to make AI take more battles - AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
	...
	WANT_TRIBUTARY_LOST_MANDATE = 15,  -- How important it is for Celestial Emperor to make tributaries out of neighbors.
	...
	FOG_OF_WAR_FORGET_CHANCE = 0.1, -- Daily percentage chance of AI forgetting a unit that's hidden in Fog of War.
	...
	DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_ONLY_NEIGHBORS = 0,  
	...
	FORT_MOTHBALL_SAFETY_DISTANCE = 125,  -- How far from the border AI will mothball forts    --Mepper: Vanilla is 5 --Beors; set to 50 (mothballing can be worth, but AI should have deep protection)
	...
	AI_CONVERT_CULTURES = 0,  -- If set to 0, AI will not convert cultures
	...
	AGGRESSIVENESS_BONUS_EASY_WAR = 450,  -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	...
	ARTILLERY_FRACTION = 0.15,  -- Ratio of artillery to infantry AI will build
	FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 40,  -- Tech level at which AI will double its artillery fraction
	TRANSPORT_FRACTION = 0.5,  -- Max fraction of naval forcelimit that should be transports
	INCOME_SAVINGS_FRACTION = 0.1,  -- AI will reserve this amount of their surplus for long-term savings
	...
	EXTRA_SURPLUS_WHEN_NEEDING_BUILDINGS = 0.00,  -- AI will aim for having at least this fraction of their income as additional surplus when they need buildings
	MAX_SAVINGS = 36,  -- AI will keep a maximum of this * their monthly income in long-term savings
	...
	ADVISOR_BUDGET_FRACTION_MIN = 0.20,  -- AI will spend a minimum of this fraction of monthly income on advisor maintenance    #Vanilla is 0.15
	ADVISOR_BUDGET_FRACTION_MERITOCRACY_MAX = 0.35,  -- If the AI has meritocracy enabled #Vanilla is 0.5, set as no impact
	ADVISOR_BUDGET_FRACTION_MERITOCRACY_MIN = 0.20,  -- If the AI has meritocracy enabled #Vanilla is 0.25, set as no impact
	ADVISOR_BUDGET_THRESHOLD = 1.5,  -- The AI will only hire an advisor if it can afford this much maintenance increase (+25%)
	STATE_MAINTENANCE_BUDGET_FRACTION = 0.15, -- AI will spend a maximum of this fraction of monthly income on state maintenance
	CORRUPTION_BUDGET_FRACTION = 0.00,  -- AI will spend a maximum of this fraction of monthly income on rooting out corruption
	COLONY_BUDGET_FRACTION = 0.6,  -- AI will spend a maximum of this amount of monthly ducats for colonies.
	...
	FORT_BUDGET_FRACTION = 0.2,  -- AI will spend a maximum of this fraction of monthly income on forts
	...
	DIPLOMATIC_INTEREST_DISTANCE = 160,  -- If border distance is greater than this, diplomatic AI will have less interest in the country
	CONQUEST_INTEREST_DISTANCE = 110,  -- If border distance is greater than this, diplomatic AI will have less interest in the country
	...
	DEVELOPMENT_CAP_BASE = 0,  -- AI will not develop provinces that have more development than this or DEVELOPMENT_CAP_MULT*original development (whichever is bigger)
	...
	PEACE_EXCESSIVE_DEMANDS_FACTOR = 0.02,  -- AI unwillingness to peace based on demanding more stuff than you have warscore
	PEACE_EXCESSIVE_DEMANDS_THRESHOLD = 30,  -- If you have less warscore than this, excessive demands will be factored in more highly
	PEACE_TIME_MONTHS = 48,  -- Months of additional AI stubbornness in a war
	PEACE_TIME_MAX_MONTHS = 600,  -- Max months applied to time factor in a war
	PEACE_TIME_EARLY_FACTOR = 0.32,  -- During months of stubbornness the effect of time passed is multiplied by this { was 0.5 }
	PEACE_TIME_LATE_FACTOR = 0.5,  -- { was 0.75 }
	PEACE_STALLED_WAR_TIME_FACTOR = 1,  -- 0.34 in vanilla. Applied to number of years war has been stalled to determine how much positive war enthusiasm is reduced
	PEACE_STALLED_WAR_THRESHOLD = 5,  -- 3 in vanilla. If the warscore has changed by this amount or less in the last year, the war is stalled
	PEACE_WAR_EXHAUSTION_FACTOR = 1.4,  
	...
	PEACE_WAR_DIRECTION_FACTOR = 0.8,  -- AI willingness to peace based on who's making gains in the war
	PEACE_WAR_DIRECTION_WINNING_MULT = 2.0,  -- Multiplies AI emphasis on war direction if it's the one making gains
	...
	PEACE_ALLY_WARSCORE_MULT = 0.6,  -- How much extra war enthusiasm from overall warscore allies in a war get
	PEACE_ALLY_TIME_MULT = 0.8,  -- Multiplies PEACE_TIME_FACTOR for allies in a war
	...
	PEACE_COALITION_FACTOR = 20,  -- AI unwillingness to peace based on being in a coalition war
	...
	PEACE_TERMS_STRATEGY_MULT = 0.85,  -- AI desire for a wargoal is multiplied by this if it doesn't fit into their general strategy
	...
	PEACE_TERMS_CHANGE_GOVERNMENT_BASE_MULT = 0.5,  -- only applied if CB is valid for it
	PEACE_TERMS_CHANGE_RELIGION_BASE_MULT = 100.0, -- only applied if CB is valid for it
	PEACE_TERMS_ANNEX_BASE_MULT = 100.0,
	PEACE_TERMS_PILLAGE_CAPITAL_MULT = 0.0,  -- AI should never use pillage capital
	PEACE_TERMS_PROVINCE_BASE_MULT = 1.2,  
	...
	PEACE_TERMS_ANNUL_TREATIES_BASE_MULT = 1,  
	...
	PEACE_TERMS_PROVINCE_NO_CB_MULT = 0.8,  -- AI desire for a province is multiplied by this if it doesn't have a valid cb for it (only used when annexing, not applied to cores)
	...
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 0.80,  -- AI desire for a province is multiplied by this if it is not the same culture
	...
	PEACE_TERMS_PROVINCE_NO_INTEREST_MULT = 0.3,  -- AI desire for a province is multiplied by this if it is not on their conquest list
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MIN_MULT = 1,  -- AI desire for a province is multiplied by this if it has 99% overextension (not applied to cores)
	...
	PEACE_TERMS_TRADE_POWER_NO_TRADE_INTEREST_MULT = 0.9,  -- AI desire for transfering trade power is multiplied by this if they are not a merchant republic
	...
	PEACE_TERMS_RETURN_CORES_NOT_FRIEND_MULT = 0.3,  -- AI desire for returning core provinces is multiplied by this if they are not friends of the country core is being returned to
	...
	PEACE_TERMS_ANNUL_TREATIES_NO_INTEREST_MULT = 0.05,  -- AI desire for annuling a treaty is multiplied by this if they have no strategic interests in doing so
	PEACE_TERMS_PROVINCE_HRE_UNJUSTIFIED_MULT = 0.025,  -- AI desire for a province is multiplied by this for HRE provinces if they are a member of the empire and don't have a CB, claim or core to it
	...
	PEACE_TERMS_RELEASE_VASSAL_HRE_MULT = 2.25,  -- AI desire for releasing a vassal is multiplied by this if both are HRE member
	...
	PEACE_TERMS_TRANSFER_VASSAL_HRE_MULT = 2.25,  -- AI desire for transfering a vassal is multiplied by this if both are HRE members.
	...
	PEACE_TERMS_WAR_REPARATIONS_BASE_MULT = 0.4,  -- AI desire for war reparations through peace
	...
	DIPLOMATIC_ACTION_TRADE_FAVORS_FOR_MEN_BASE_SCORE = 0,  
	DIPLOMATIC_ACTION_TRADE_FAVORS_FOR_MEN_PREPARING_FOR_WAR_SCORE = 0,  
	DIPLOMATIC_ACTION_TRADE_FAVORS_FOR_MEN_MILITARIST_MULT = 0,  

	DIPLOMATIC_ACTION_TRADE_FAVORS_FOR_SAILORS_BASE_SCORE = 0,  
	DIPLOMATIC_ACTION_TRADE_FAVORS_FOR_SAILORS_PREPARING_FOR_WAR_SCORE = 0,  
	DIPLOMATIC_ACTION_TRADE_FAVORS_FOR_SAILORS_MILITARIST_MULT = 0,  
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_HRE_FACTOR = 0.65,  -- AI scoring for fabricating claims if both parts are HRE.
	...
	DIPLOMATIC_ACTION_SUBSIDIES_RELATIONS_FACTOR = 0.5,  -- AI scoring for giving subsidies to a country based on opinion of the other country
	...
	FOREIGN_MINISTER_IGNORE_DISTANCE_BASE = 8,  --Mepper: Vanilla is 8, set to 6 for now to save performance
	FOREIGN_MINISTER_BASE_PROVINCE_COUNT = 2,  --Mepper: Vanilla is 2, set to 3 for now to save performance
	...
	INVADING_MAX_AWAY_RATIO = 0.9,								-- vanilla 0.45 - AI will never send more than this ratio to invade (Measured in strength)
	-- > Beorsferth: Allow the AI to use more of its army to make invasions
	...
	HOME_FLEET_MAX_RATIO = 0.80,								-- Maximum proportion of warships in home fleet.
	...
	MAX_ARMIES_NEW_REGION_ASSIGN_ALGORITHM = 24,
	-- Max. amount of armies to use in new region assignment algorithm (fall back to old one).
	...
	MAX_TASKS_NEW_REGION_ASSIGN_ALGORITHM = 200,
	-- Max. amount of tasks to use in new region assignment algorithm (fall back to old one).
	...
	INVASION_ARMY_LOOKUP_INTERVAL_ON_FAILURE = 5,				-- vanilla = 5 - If AI fails to find an army for an invasion it will try again in this number of days
	...
	ARMY_DISTANCE_SCORE_IMPACT = 0.625,							-- Army <-> province distance impact on province evaluation. -- Vanilla value is 0.5.
	...
	BORDER_DISTANCE_SCORE_IMPACT = 2.5,							-- Border <-> province distance impact on province evaluation. -- Vanilla value is 3.
	-- Rosth: same principle as described above, only here the distance value is multiplied directly by this number. The further the province is from the AI's border, the less desireable it is.
	IMPORANT_PROVINCE_THRESHOLD = 0.015, 	-- AI will try to defend provinces under threat worth more than this percentage of total development. Vanilla value is 0.05.
	REGION_PLANNING_HOMELAND_PRIORIZATION = 6, -- Homeland priorization when assigning armies to regions (only applied when actually threatened). Vanilla value is 5.1.
	-- Rosth: I'm assuming "homeland" either means "non-overseas provinces" or AI region that has it's capital. Either way prioritizing provinces closest to the capital would probably be better in most situations. 
	...
	APPOINT_CARDINAL_IN_OWNED_LAND_AI_DESIRE = 0,  -- AI scoring for appoint cardinals in owned land, multiplied by budget/cost
	...
	APPOINT_CARDINAL_SHARE_OF_TREASURY = 0,  -- Share of treasury upper bound to the cost of appoint cardinal for the Papal State to appoint cardinals in its own land
	APPOINT_CARDINAL_WANTS_BEFRIEND = 0,  -- AI scoring for appoint cardinals is increased by this if they have an attitude with 'befriend' desire
	APPOINT_CARDINAL_WANTS_ALLY = 0,  -- AI scoring for appoint cardinals is increased by this if they have an attitude with 'ally' desire
	APPOINT_CARDINAL_CAN_INTEGRATE = 0,  -- AI scoring for appoint cardinals is increased by this if they can integrate/annex the target and inherit the cardinals
	ESTATE_PRIVILEGE_REVOKE_THRESHOLD = -1,  
	...
	ESTATE_MAX_WANTED_INFLUENCE = 100.0,  
	ESTATE_MIN_WANTED_CROWNLAND = 0.0,  
	ESTATE_MAX_PRIVILEGES = 999,  
	MIN_SCORE_TO_CONCENTRATE_DEVELOPMENT = 9999,  --Crazy high value to try to block AI from using this interaction. Player can't see button so can't use anyway.
...
NGraphics = {
	...
	RIVER_MEMORY_BUFFER = 500000,  -- vanilla 250000	Increase this if you want to add more rivers to the game
	PORT_SHIP_OFFSET = 2.0,
	SHIP_IN_PORT_SCALE = 0.40,  
	...
	CITY_SPRAWL_AMOUNT = 1.5,  -- vanilla 3.0		Size of cities, higher gives larger cities
	...
	MAX_TRADE_NODE_FLAGS_SHOWN = 20,  -- -1 is unlimited
	SHOW_TRADE_MODIFIERS_IN_TRADE_MAP_MODE = 1,  -- 1 = true, 0 = false
	END_OF_COMBAT_GFX = 1,  -- vanilla 1
...
NGui = {
	PROVINCE_FOCUS_ZOOM_HEIGHT = 0.1,  

	MACRO_BUILD_FOCUS_ZOOM_HEIGHT = 0.1,  
	MACRO_BUILD_BIG_SMALL_HEIGHT = 0.1,  
...
NFrontend = {
	CAMERA_LOOKAT_X = 2787.0,  
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1845.0,  
	CAMERA_LOOKAT_SETTINGS_X = 2787.0,  
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1845.0,  
	CAMERA_START_X = 2787.0,  
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 1755.0,  
	CAMERA_END_X = 2787.0,  
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 1700.0,  
	CAMERA_MIN_DIST_FOR_ROTATE = 300.0,  -- vanilla = 800.0 	Controlls when rotation starts. When camera is close enought it starts
	CAMERA_MIN_HEIGHT = 40.0,  -- Minimum camera height
...
NReligion = {
	...
	CONSECRATE_PATRIARCH_THRESHOLD = 2000,  
	...
	MAYA_COLLAPSE_PROVINCES_PER_REFORM = 1,  
	...
	YEARLY_PAPAL_INFLUENCE_CATHOLIC = 0.10,  -- The amount of yearly papal influence you receive each year for being catholic
	YEARLY_PAPAL_INFLUENCE_PER_CARDINAL = 0.15,  -- The amount of yearly papal influence you receive each year for each cardinal you have active
	...
	MAX_PAPAL_INFLUENCE = 500.0,  -- The maximum stored amount of papal influence for each country.
	REFORM_DESIRE_PER_YEAR = 0.001,  
	MINIMUM_DEVELOPMENT_ALLOWED = 0.001,  -- You will need a higher development than this for your province to be eligible for cardinal
	COUNTRY_DEVELOPMENT_DIVIDER = 200.0,  -- When a cardinal is chosen the formula is diving a countrys development by this number.
	INVEST_PAPAL_INFLUENCE = 400.0,  -- The amount of papal influence you invest in becoming controller of the curia.
	...
	EXPEL_RELIGIOUS_MINORITY_THRESHOLD = 0.45,  -- Minimum conversion chance required to expel a religious minority from a province
	EXPELLED_MINORITY_DURATION = 27375,  -- Duration of the "expelled_minority" modifier
...
NNationDesigner = {
	...
	BASE_TAX_COST_MODIFIER = 0.8,  
	PRODUCTION_COST_MODIFIER = 1.2,  
	MANPOWER_COST_MODIFIER = 0,  
	GOLD_PROVINCE_COST_MULTIPLIER = 3,
	TECH_GROUP_COST_MODIFIER = 1,
	MEMBER_OF_HRE_COST = 0,  -- Cost for being part of the HRE (base)
	MEMBER_OF_HRE_PROVINCE_COST = 0.0,  -- Cost for being part of the HRE (extra cost multiplier on provinces)
	...
	ALL_MALE_MALE_CHANCE = 95,  -- Chance for females if starting ruler and heir were both male.
	MAX_GOVERNMENT_RANK = 6,  
	GOVERNMENT_RANK_COST_1 = 0,  
	GOVERNMENT_RANK_COST_2 = 0,  
	GOVERNMENT_RANK_COST_3 = 0,  

	MANDATE_SUBCONTINENT_NAME = "north_china_superregion",  -- Name of the subcontinent where the Mandate will be given to the biggest nation by development when using random generated nations
},
...
NGovernment = {
	...
	GOVERNMENT_REFORM_COST_CENTRALIZE_STATE = 99999,  --Attempt to block AI from centralizing state. Player can't do it in any case because they can't see the button.
	CENTRALIZE_STATE_ADM_COST = 99999,  
	...
	EXPAND_ADMIN_COST = 99999.0,  -- Vanilla default is 20, but I want to block the button.
